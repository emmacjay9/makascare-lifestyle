...
const fallbackProducts: Product[] = fallbackData
  .trim()
  .split("\n")
  .map((line) => {
    const [name, category, image] = line.split("|");
  ...
  useEffect(() => {
    async function loadProducts() {
      try {
        ...
        console.error("Could not load Sanity products:", error);
      }
    }
